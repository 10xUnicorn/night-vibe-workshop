      ...
      <section className="section">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 40, alignItems: 'center', textAlign: 'left', maxWidth: 960, margin: '0 auto' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 16 }}>Daniel builds AI-powered business systems that create real, measurable impact. His systems have generated nearly $100M in revenue for the organizations and clients he has built for.</p>
            <p style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 24 }}>He has personally earned approximately $400K in commissions from the systems he has built — and now teaches business owners how to do the same using the latest AI tools. His approach is practical, direct, and focused entirely on execution.</p>
            <div style={{ display: 'flex', gap: 32 }}>
              <div><div style={{ fontSize: 24, fontWeight: 800 }} className="gradient-text">~$100M</div><p style={{ fontSize: 12, color: 'var(--text-muted)' }}>Revenue from systems built</p></div>
              <div><div style={{ fontSize: 24, fontWeight: 800 }} className="gradient-text">~$400K</div><p style={{ fontSize: 12, color: 'var(--text-muted)' }}>Commissions earned</p></div>
            </div>
          </div>
        </div>
      </section>
